...
<script>
  ...
  import CourseCreate from '../components/ClassCreate.vue'
  import CourseList from '../components/ClassList.vue'
  import CourseDashboard from '../components/ClassBody.vue'
