...
module.exports = {
  async up (queryInterface, Sequelize) {
    await queryInterface.changeColumn('nb_log', 'event', 
      {type: Sequelize.ENUM,
    ...
    await queryInterface.addColumn('nb_log', 'is_comment_endorsed', {
      type:  Sequelize.BOOLEAN,
      allowNull: false,
      defaultValue: false
  });
  await queryInterface.addColumn('nb_log', 'is_comment_followed', {
    type:  Sequelize.BOOLEAN,
    allowNull: false,
    defaultValue: false
  });
  await queryInterface.addColumn('nb_log', 'slider_value', {
  ...
  async down (queryInterface, Sequelize) {
    ...
    await queryInterface.removeColumn('nb_log', 'is_comment_endorsed');
    await queryInterface.removeColumn('nb_log', 'is_comment_followed');
    await queryInterface.removeColumn('nb_log', 'slider_value');
  }
};
